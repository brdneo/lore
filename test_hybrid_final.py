...
def main():
    ...
    try:
        ...
        print(f"🧬 Módulos: Genetic, Neural, Types, Utils")
        ...
        print(f"   📊 Fitness: min={min(fitness_values):.3f}, max={max(fitness_values):.3f}, avg={np.mean(fitness_values):.3f}")
        ...
        print(f"   💡 Trade-off: Complexidade vs Performance")
