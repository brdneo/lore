    ...
    def decide_and_act(self):
        ...
        try:
            ...
            if influenced_factors["products"] and "genetic_score" in influenced_factors["products"][0]:
                ...
                self.logger.info(f"Genetic decision: Buying artifact with genetic score {best_artifact_data['genetic_score']:.3f}")
            else:
            ...
            self.logger.info(f"Decision: Attempting to buy artifact: '{cheapest_artifact['name']}' for {cheapest_artifact['current_price']}.")
